...
const THEME_OPTIONS = [
  {
    value: "system",
    label: "System",
    description: "Follows your OS preference. Dark maps to Caladan Night, light maps to Atreides Dawn.",
  },
  {
    value: "caladan-night",
    label: "Caladan Night",
    description: "Deep navy, storm-blue accent. Calm authority.",
  },
  {
    value: "atreides-dawn",
    label: "Atreides Dawn",
    description: "Warm gold on a dark base. Desert sunrise.",
  },
  {
    value: "imperial-ember",
    label: "Imperial Ember",
    description: "Deep orange, restrained intensity.",
  },
] as const;
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
            <header className="space-y-1">
              <h1 className="text-2xl font-semibold tracking-tight text-[oklch(0.68_0.19_35)]">Settings</h1>
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                <h2 className="text-sm font-medium text-primary">Codex App Server</h2>
                <p className="mt-1 text-xs text-muted-foreground">
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                <h2 className="text-sm font-medium text-primary">Models</h2>
                <p className="mt-1 text-xs text-muted-foreground">
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                <h2 className="text-sm font-medium text-primary">Responses</h2>
                <p className="mt-1 text-xs text-muted-foreground">
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                <h2 className="text-sm font-medium text-primary">Keybindings</h2>
                <p className="mt-1 text-xs text-muted-foreground">
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                <h2 className="text-sm font-medium text-primary">Safety</h2>
                <p className="mt-1 text-xs text-muted-foreground">

  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-x-hidden bg-background">
      ...
      <div
        ...
        style={{ maskImage: "linear-gradient(to bottom, transparent 0%, black 3%, black 100%)", WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, black 3%, black 100%)" }}
      ...
      <div className={cn("px-3 pt-1.5 sm:px-5 sm:pt-2", isGitRepo ? "pb-1" : "pb-3 sm:pb-4")}>
        ...
        >
          <div
            className={`group rounded-[20px] border bg-card shadow-[0_0_40px_-2px_var(--primary-glow),0_0_80px_-10px_var(--primary-glow-outer)] transition-[border-color,box-shadow] duration-200 focus-within:border-ring/45 focus-within:shadow-[0_0_45px_0px_var(--primary-glow-focus),0_0_90px_-8px_var(--primary-glow-outer-focus)] ${
              isDragOverComposer ? "border-primary/70 bg-accent/30" : "border-border"
            }`}
            style={{
              '--primary-glow': 'color-mix(in srgb, var(--primary) 7%, transparent)',
              '--primary-glow-outer': 'color-mix(in srgb, var(--primary) 3%, transparent)',
              '--primary-glow-focus': 'color-mix(in srgb, var(--primary) 12%, transparent)',
              '--primary-glow-outer-focus': 'color-mix(in srgb, var(--primary) 5%, transparent)',
          ...
          return (
            <>
              ...
              <div className="min-w-0 px-1 py-0.5">
                ...
                <p className="mt-1.5 text-[10px] text-primary/25">
                  {formatMessageMeta(
  ...
  if (!hasMessages && !isWorking) {
    return (
      <div className="relative flex h-full flex-col items-center justify-center overflow-hidden">
        ...
        <p className="relative -mt-6 mb-1 text-sm text-muted-foreground/30">
